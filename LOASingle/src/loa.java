...
public class loa extends Applet implements Runnable {
    ...
    public void paint( Graphics g ){
      ...
      if ( user_move == CustomCanvas.WAIT2 ) {
    ...
    public void run() {
      ...
      showStatus( status );
      while (true) {
    	if (board.game_state != Board.GAME_OVER)
	      make_user_move();
    	if (board.game_state != Board.GAME_OVER)
	      get_comp_move();
      }
     ...
     * GUI interface, and provides information for the player and once a piece
    ...
    public void make_user_move() {
      ...
      while ( user_move != CustomCanvas.NOT_MOVE )
      {
        ...
        case CustomCanvas.PICK_MOVE:
          ...
          if (user_move != CustomCanvas.NOT_MOVE)
        	user_move = CustomCanvas.WAIT1;
